...
sprite_sheets_image = pygame.image.load("smb_mario_sheet.png").convert_alpha()
...
for animation in animation_steps:
    ...
    for _ in range(animation):
        temp_img_list.append(sprite_sheet.get_image(step_counter, 30, 32, 3, purple))
        step_counter += 1
